...
#### O que pretendo implementar?
Além das funcionalidades básicas de um Pomodoro, também vai ter:
- Personalização no tempo da sessão e do descanso;
- Sequência de timers com label;
- Visualizar métricas de pomodoros e sessões concluídas e não concluídas.
